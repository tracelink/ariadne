...
public class AnalyzerTest {
	...
	public void testAnalyzeDependencies() {
		...
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-a:1.0",
				"com.example:project-b:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-b:1.0",
				"com.example:project-c:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-b:2.0",
				"org.third.party:library-d:1.0"));
		dependencies
				.add(new AbstractMap.SimpleEntry<>("org.third.party:library-d:1.0",
						"org.third.party:library-e:1.0"));
	...
	public void testAnalyzeTiersLoop() {
		...
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-b:1.0",
				"com.example:project-c:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-c:1.0",
				"com.example:project-a:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-c:1.0",
				"com.example:project-d:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-d:1.0",
				"org.third.party:library-e:1.0"));
		dependencies
				.add(new AbstractMap.SimpleEntry<>("org.third.party:library-f:1.0",
						"org.third.party:library-g:1.0"));
		dependencies
				.add(new AbstractMap.SimpleEntry<>("org.third.party:library-g:1.0",
						"org.third.party:library-h:1.0"));
		dependencies
				.add(new AbstractMap.SimpleEntry<>("org.third.party:library-h:1.0",
						"org.third.party:library-f:1.0"));
	...
	public void testAnalyzeTiersAboveLoop() {
		...
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-c:1.0",
				"com.example:project-d:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-i:1.0",
				"com.example:project-a:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-d:1.0",
				"org.third.party:library-e:1.0"));
		dependencies
	...
	public void testAnalyzeTiersNotMostRecentVersion() {
		...
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-a:1.0",
				"com.example:project-b:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-a:2.0",
				"com.example:project-d:1.0"));
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-b:1.0",
				"org.third.party:library-c:1.0"));
	...
	public void testAnalyzeTiersTransitiveVulnerability() {
		List<Map.Entry<String, String>> dependencies = new ArrayList<>();
		dependencies.add(new AbstractMap.SimpleEntry<>("com.example:project-a:1.0",
				"org.third.party:library-b:2.0"));
		dependencies
				.add(new AbstractMap.SimpleEntry<>("org.third.party:library-b:2.0",
						"org.third.party:library-c:3.0"));
		dependencies
				.add(new AbstractMap.SimpleEntry<>("org.third.party:library-b:2.0",
						"org.third.party:library-d:4.0"));
